...
<?php $pendapatan = $lihat -> untung_row();?>
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=barang'>
                    Tabel Barang <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=kategori'>
                    Tabel Kategori <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-secondary text-white">
                <h6 class="pt-2"><i class="fas fa-upload"></i> Penjualan</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=laporan'>
                    Tabel laporan <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-secondary text-white">
                <h6 class="pt-2"><i class="fas fa-cubes"></i> Pendapatan</h6>
            </div>
            <div class="card-body">
                <center>
                    <h1><?php echo number_format($pendapatan['untung']);?></h1>
                </center>
            </div>
            <div class="card-footer">
                <a href='index.php?page=laporan'>
...
<button class="btn btn-success mt-3">
    <a href="index.php?page=jual" class="text-white">
